...
urlpatterns = [
    ...
    path('api/users/<int:user_id>/active-assignment/', get_user_active_assignment, name='get_user_active_assignment'),
    ...
    path('home/', Home.as_view(), name='frmt-home'),
    ...
    path('transactions/new/', TransactionAppCreateView.as_view(), name='frmt-transaction-create'),
